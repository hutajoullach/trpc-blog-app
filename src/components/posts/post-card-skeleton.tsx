...
const PostCardSkeleton = () => {
  return (
    <>
      <div
        role="status"
        className="max-w-sm animate-pulse rounded-2xl border border-gray-200 p-2 shadow dark:border-gray-700 md:p-6"
      >
        ...
        <div className="mt-4 flex items-center space-x-3">
          <svg
            className="h-12 w-10 text-gray-200 dark:text-gray-700"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 20 20"
